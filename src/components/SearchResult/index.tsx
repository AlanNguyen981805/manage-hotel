...
import { AdditinalCosts, Hotel, Service, Transportation } from "./components";
          ...
          <div className="flex min-h-full overflow-y-auto items-center justify-center p-4">
            ...
            >
              <div className="w-full px-4 items-center flex flex-col ">
                          ...
                          <DisclosureButton className="group flex w-full items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <Dropdown
                                ...
                                onChange={(value) => handleSelectCityByDay(value, dayIndex)}
                              />
                            </div>
                            <ArrowDown />
                          </DisclosureButton>
                ...
                <button className="bg-accent text-white px-4 rounded-md h-[40px] mb-2" onClick={handleSubmit}>
                  Đặt Phòng
                </button>
              </div>
            </DialogPanel>

...
import { IAdditionalCosts, IFormSearchResult, IHotel, IService, ITransportation } from "../defination";
...
const useFormSearchResult = ({setForm, type, dayIndex, initialData}: IProps) => {
